using DotNetDILifeTime.Models;
using DotNetDILifeTime.Service;
using Microsoft.AspNetCore.Mvc;
using System.Diagnostics;

namespace DotNetDILifeTime.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, ITransientService transientService1, ITransientService transientService2,
                              IScopedService scopedService1, IScopedService scopedService2, ISingletonService singletonService1, ISingletonService singletonService2)
        {
            _logger = logger;
